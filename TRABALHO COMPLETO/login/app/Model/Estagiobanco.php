<?php
require_once __DIR__ . "/Estagio.php"; // Inclui a classe Estagio
...
class Estagiosbanco {
    ...
    public function __construct() {
        ...
        $this->pdo = $banco ?? new PDO("sqlite:banco.db"); // Garante uma conexão PDO
    }
    ...
    // Método para cadastrar um novo estágio
    ...
    // Método para listar estágios associados a um usuário
    ...
    // Método para hidratar objetos de estágio
