...
if ($usuarioId) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['avaliar'])) {
        // Recebe os dados do formulário de avaliação
        $estagioId = $_POST['estagio_id'];
        $nota = $_POST['nota'];
        $comentario = $_POST['comentario'];

        try {
            // Conecta ao banco de dados e insere a avaliação
    ...
    // Obtém os estágios para avaliar
...
<section class="section">
    <div class="container">
        ...
        <?php if (isset($mensagem)) { echo $mensagem; } // Exibe a mensagem de sucesso ou erro ?>
