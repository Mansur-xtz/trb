...
$id = $_GET['id']; // Obter o ID diretamente
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['atualizar'])) {
        ...
        // Atualiza os dados do estágio no banco
        ...
        // Exclui o estágio e redireciona com notificação
...
// Busca o estágio atual no banco de dados
