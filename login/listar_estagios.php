...
<?php foreach($estagios as $estagio): ?>
    <tr>
        ...
        <td>
            ...
            <a class="button is-small is-danger" href="excluir_estagio.php?id=<?= htmlspecialchars($estagio->getid()) ?>" onclick="return confirm('Tem certeza que deseja excluir este estágio?')">Excluir</a>
        </td>
    </tr>
<?php endforeach; ?>
